...
stripe.api_key = 'sk_test_51MrNSnKca3dGUrgMHxLN9RoaA8d14TrfiXOlsoHxXBxBcU4SoIGGxLMDlC7VazGDM91ttCshAy5lkK0zXR64XydR009MUiim5h'
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        plan = 'price_1MrO2zKca3dGUrgMag3z0ejx'
        if request.POST['plan'] == 'yearly':
            plan = 'price_1MrOB3Kca3dGUrgM2H73LN2N'
        ...
        if request.method == 'GET' and 'coupon' in request.GET:
            ...
            {'plan':plan, 'coupon':coupon, 'price':price, 'og_dollar':og_dollar,'coupon_dollar':coupon_dollar,'final_dollar':final_dollar})
